...
for J=1:4
    ...
    for K=1:3
        ...
        [Mxc,Mzc]=meshgrid([0.1:0.2:1.4],[-0.9:0.2:0.1]);
        len=0.05;
        for I=1:numel(Mxc)
            xc=Mxc(I);
            zc=Mzc(I);
        ...
        if K==1
            switch J
                case 1
                    ...
                    text(0.8,-0.1,'(a): $\theta_0=\pi/2$',TX{:},FSm{:});
                case 2
                    %title('$s_\mathrm{reaction}$',TX{:},FSm{:});
                    text(0.8,-0.1,'(b): $\theta_0=\pi/4$',TX{:},FSm{:});
                case 3
                    %title('$s_\mathrm{reaction}$',TX{:},FSm{:});
                    text(0.8,-0.1,'(c): $\theta_0=0$',TX{:},FSm{:});
                case 4
    ...
    print(strcat(path_spec,'MOR_growth_combined'),output_format)
